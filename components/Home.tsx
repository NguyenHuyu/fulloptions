    ...
    <div className='w-full flex flex-col h-full  font-serif  bg-[#061629] '>
      <div className='container mx-auto h-screen  px-6 py-16 text-center'>
        <div className='mx-auto max-w-lg'>
          <h1 className='text-3xl  text-[#117b6b] lg:text-6xl font-sans'>GLOBAL CREATIVE MINDS AGENCY</h1>
      ...
      <div className=' flex justify-center flex-col items-center py-20 bg-[#061629]  text-left space-y-10'>
        ...
        <Link href='project'>
          <div className='md:p-8 md:py-16 text-sm md:text-md p-4 rounded-full bg-red-900'>View project</div>
        </Link>
      </div>

      <div className='flex flex-col justify-center bg-[#061629] md:py-20  text-left md:space-y-10 gap-14'>
        ...
        <div className='marquee-container py-10 md:my-20'>
      ...
      <div className='flex flex-col justify-center bg-[#061629]  text-left space-y-10 gap-14'>
        <div className='flex justify-around items-center pt-10 md:pt-0 p-4'>
          <h2 className='w-[40rem] text-xl md:text-5xl  '>Expolore Our Recent Sucessfull Work</h2>
          <h2 className='text-xl md:text-2xl text-[#20c781]'>SERVICES</h2>
        </div>
        <div className='grid-container'>
          <div className='flex gap-3 '>
            {card2s.map((card, index) => (
              <div
                key={index}
                className=' card w-[90vw] md:w-[900px] h-[21rem] border border-[#093240] bg-[#061629] hover:bg-[#093240]'
              >
                <Image
                  src={card.image}
                  alt='user'
        ...
        <div className='grid md:grid-cols-4 mx-auto gap-4 md:max-w-6xl '>
      ...
      <div className='flex flex-col justify-center h-full md:h-screen bg-[#061629] text-left space-y-10 gap-14'>
        ...
        <div className='grid-container p-0'>
          <div className='flex gap-3  p-0'>
            {card3s.map((card, index) => (
              <div
                key={index}
                className='card w-[90vw] md:w-[500px] h-[23rem] border border-[#093240] bg-[#061629] hover:bg-[#093240]'
              >
                <Image
                  src={card.image}
                  alt='user'
                  width={1000}
                  height={1000}
                  className='hover:scale-125 duration-250'
                />
      ...
      <div className=" flex flex-col  items-center  justify-center h-screen bg-[#061629] text-left space-y-10  bg-[url('/ima2.jpg')]">
        <p className='text-[#20c781]'>TEAM</p>
        <p className='text-5xl'>Our Professional Team</p>
        <div className='pt-10'>
          {images?.length > 0 && (
            <div className='relative slider flex'>
              ...
              >
                {images.map((imageUrl: any, index: any) => (
                  <div
                    key={index}
                    className='max-h-[300px] gap-20 flex flex-col mx-auto justify-center items-center md:max-h-[600px] lg:max-h-[60vh]'
                  >
                    <div className='w-[20rem] object-cover  duration-200 transition-opacity text-center'>
                      {imageUrl.title}
                    </div>
                    <div className='flex items-center gap-10'>
                      <Image src={imageUrl.img} width={100} height={1000} alt='$4df' />
                      <div className='w-full object-cover  duration-200 transition-opacity'>{imageUrl.name}</div>
                    </div>
                  </div>
                ))}
              </Carousel>
